...
function loginFunc(){
    $("#login").on("click",function(){
        ...
        if($("#login_res_pwd").html() != "")return;
            ...
            // $.post('http://cjl3.rokyinfo.net:7200/auth/token ', {'username': username,'userpwd':userpwd}, function(data){// });
            $.ajax({
                ...
                success:function(json){
                    ...
                    window.location.href="./houtai/index.html";
                    top.window.location="./houtai/index.html";
